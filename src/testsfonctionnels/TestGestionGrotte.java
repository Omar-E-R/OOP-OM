...
public class TestGestionGrotte {
	...
	public static void main(String[] args) throws ZoneDeCombatNonCompatibleException {
		Monstre<Feu> dragotenebre = new Monstre<>("dragotenebre", 200, ZoneDeCombat.AERIAN, Domaine.FEU,
				new BouleDeFeu(4), new Lave(1), new Eclair(3));

		Monstre<Tranchant>[] tableauVampirien = new Monstre[10];
		for (int i = 0; i < 10; i++) {
			tableauVampirien[i] = new Monstre<>("vampirien", 10, ZoneDeCombat.AERIAN, Domaine.TRANCHANT,
					new Morsure(10));
		}
		...
		Monstre<Glace> soufflemort = new Monstre<>("soufflemort", 120, ZoneDeCombat.AERIAN, Domaine.GLACE,
				new Tornade(8));
		...
		grotte.ajouterSalle(ZoneDeCombat.AERIAN, dragotenebre);
		grotte.ajouterSalle(ZoneDeCombat.TERRESTRE, cramombre);
		grotte.ajouterSalle(ZoneDeCombat.TERRESTRE, givrogolem);
		grotte.ajouterSalle(ZoneDeCombat.AERIAN, tableauVampirien);
		...
		grotte.ajouterSalle(ZoneDeCombat.AERIAN, soufflemort);
